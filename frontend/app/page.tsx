        ...
        <div className="grid grid-2" style={{ marginTop: "1.5rem" }}>
          ...
          <div className="card">
            ...
            <div className="grid" style={{ gap: "1rem" }}>
              ...
              <p className="muted">
                Use sorting to prioritize what matters now. Tasks without deadlines
                appear last in deadline mode.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", gap: "1rem" }}>
                    <div>
                      ...
                      <div className="todo-meta">
                        <span className={`badge ${todo.completed ? "completed" : ""}`}>
                    ...
                    >
                      Mark {todo.completed ? "open" : "done"}
                    </button>
                  </div>

                  {todo.description && (
                    <p className="muted" style={{ margin: 0 }}>{todo.description}</p>
                  )}
